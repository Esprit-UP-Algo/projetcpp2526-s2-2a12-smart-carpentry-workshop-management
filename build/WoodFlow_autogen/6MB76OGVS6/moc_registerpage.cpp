...
template <> constexpr inline auto RegisterPage::qt_create_metaobjectdata<qt_meta_tag_ZN12RegisterPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const Employee &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void RegisterPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (RegisterPage::*)(const Employee & )>(_a, &RegisterPage::registerSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (RegisterPage::*)()>(_a, &RegisterPage::switchToLogin, 1))
            return;
    }
}
