...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loginSuccess((*reinterpret_cast<std::add_pointer_t<Employee>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)(const Employee & )>(_a, &LoginPage::loginSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::switchToRegister, 1))
            return;
    }
}
...
// SIGNAL 0
void LoginPage::loginSuccess(const Employee & _t1)
{
