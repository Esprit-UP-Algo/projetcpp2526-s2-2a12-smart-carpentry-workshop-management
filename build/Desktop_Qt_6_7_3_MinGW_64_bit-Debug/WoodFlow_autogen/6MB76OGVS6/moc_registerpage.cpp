...
void RegisterPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->registerSuccess((*reinterpret_cast< std::add_pointer_t<Employee>>(_a[1]))); break;
        ...
        {
            using _t = void (RegisterPage::*)(const Employee & );
            if (_t _q_method = &RegisterPage::registerSuccess; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &RegisterPage::switchToLogin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegisterPage::registerSuccess(const Employee & _t1)
{
