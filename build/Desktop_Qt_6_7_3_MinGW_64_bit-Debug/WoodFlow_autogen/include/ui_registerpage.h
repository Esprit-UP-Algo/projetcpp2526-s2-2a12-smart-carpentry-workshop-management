...
public:
    ...
    void retranslateUi(QWidget *RegisterPage)
    {
        ...
        label->setText(QCoreApplication::translate("RegisterPage", "Nom d'utilisateur", nullptr));
        usernameInput->setPlaceholderText(QCoreApplication::translate("RegisterPage", "Choisissez un nom d'utilisateur", nullptr));
        label1->setText(QCoreApplication::translate("RegisterPage", "Email", nullptr));
        emailInput->setPlaceholderText(QCoreApplication::translate("RegisterPage", "Entrez votre email", nullptr));
